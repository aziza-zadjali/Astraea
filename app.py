...
def main():
    ...
    with st.sidebar:
        ...
        option = st.radio(
            ...
            ('Query from Document', 'Get Legal Advice', 'Oman Laws', 'Legal Translation Service', 'Grade Legal Document') if lang_code == "en" else
            ('استعلام من وثيقة', 'الحصول على استشارة قانونية', 'قوانين عمان', 'خدمة الترجمة القانونية', 'تقييم الوثيقة القانونية'),
            key="feature_select"
        )
    ...
    elif option == 'Grade Legal Document':
